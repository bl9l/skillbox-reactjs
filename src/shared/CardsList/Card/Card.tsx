  ...
  return (
    <li className={styles.card}>
      <div className={styles.textContent}>
        <h2 className={styles.title}>Но представители современных социальных течений</h2>
      ...
      <div className={styles.previewImage}>
        <CardPreviewImage src="https://www.industrialempathy.com/img/remote/ZiClJf-1920w.jpg"/>
      </div>
